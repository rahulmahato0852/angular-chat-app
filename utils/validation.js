...
exports.ValidationNew = (res, data = [{ value: "rahulmahato0852@gmail.com", validations: [{ key: "isEmpty", except: false }, { key: "isEmail", except: true }] }]) => {
    for (let i = 0; i < data.length; i++) {
        ...
        for (let j = 0; j < data[i].validations.length; j++) {
            ...
            if (result !== validation.except) {
                ...
                res.status(400).json({ message: messageObj })
